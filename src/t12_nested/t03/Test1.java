...
public class Test1 {
	...
	public void modClass() {
		...
		class Aa{ //기본생성자
			...
			public Aa() {
				System.out.println("이곳은 Test1클래스안의 modclass()메소드안의 Aa클래스입니다.");
			}
			
			public void modTest1A() {
				System.out.println("이곳은 Test1클래스안의 modclass()메소드안의 modTest1A()메소드입니다.");
			}
		}
		//로컬클래스는 메소드안에서 생성되기에, 메소드 안에서만 사용가능하다.
		//메소드를 벗어나면 클래스는 소멸된다.
		System.out.println("!!!!!!!!!!!!!!!!!!!");
		
		
		Aa aa = new Aa(); //클래스를 생성하는거
