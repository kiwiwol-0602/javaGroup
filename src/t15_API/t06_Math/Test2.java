...
public class Test2 {
	public static void main(String[] args) {
		...
		System.out.println("0~10미만의 정수형난수 : " + random.nextInt(10)); 
		System.out.println("0~10의 정수형난수 : " + (random.nextInt(10)+1)); 
		System.out.println("5~10의 정수형난수 : " + (random.nextInt(10+1-5)+5)); 
		System.out.println("20~30의 정수형난수 : " + (random.nextInt(30+1-20)+20)); 
		System.out.println();
