...
public class Test2 {
  public static void main(String[] args) {
     ...
     String regEx6 = "^[a-zA-Z0-9가-힣 _-]*$"; //이름은 영문자,한글,공백,숫자,밑줄,하이폰 만이 포함된 글자만을 허용
...
//     regEx2      
     if (Pattern.matches(regEx2, str1)) {
        System.out.println("11. 영문자와 숫자로만 구성되어 있다.");
     }
     else {
...
//   regEx3    
     if (Pattern.matches(regEx3, str1)) {
        System.out.println("21. 이름이 영문과 한글로만 구성되어 있다");         
     }
     else {
        System.out.println("21. 이름이 영문과 한글아닌 구성문자가 포함되어 있다");         
     }
...
//   regEx4    
     if (Pattern.matches(regEx4, str1)) {
    	 System.out.println("31. 공백문자만 있습니다.");         
     }
     else {
    	 System.out.println("31. 공백이 아닌 문자가 있습니다.");         
     }
