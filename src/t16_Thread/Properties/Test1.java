...
public class Test1 {
	public static void main(String[] args) {
		...
		System.out.println("2.현재 동작하는 스레드 개수 : "+Thread.activeCount()); //2개이상
		System.out.println();
		...
		System.out.println("3.현재 동작하는 스레드 개수 : "+Thread.activeCount());
		System.out.println();
		...
		System.out.println("4.현재 동작하는 스레드 개수 : "+Thread.activeCount());
		System.out.println();
	}
}
