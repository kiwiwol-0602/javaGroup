...
insert into test values (default,'김말숙',30,'여자','청주');/*test와 values 사이에 필드를 적지 않았을땐, 데이터필드의 갯수와 순서가 똑같이 들어가 있어야 함*/
insert into test values (default,'오하늘',default,default,'');
insert into test (name) values ('이사랑');
insert into test values (default,'가나다',22,'여자','청주');
insert into test values (default,'강감찬',24,'남자','청주');
insert into test values (default,'이사랑',25,'여자','천안');
insert into test values (default,'김그린',27,'남자','대전');
insert into test values (default,'강현민',29,'여자','인천');
insert into test values (default,'고릴라',33,'남자','서울');
insert into test values (default,'전감자',37,'여자','제주');
insert into test values (default,'이자바',40,'남자','청주');
insert into test values (default,'김자월',22,'여자','제주');
insert into test values (default,'오자월',22,'여자','제주');
insert into test values (default,'오이자월',22,'여자','청주');
insert into test values (default,'김자월화',36,'여자','청주');
